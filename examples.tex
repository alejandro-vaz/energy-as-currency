...
For the transaction to be successfully created, the decision on node $13$ has to pass. We'll first compute the voting power matrix, using the Katz centrality from \ref{subsection:katzce}:
    $$V = R \circ C^T$$
\begin{figure}[H]\centering\includegraphics[width=0.8\textwidth]{lagrida_latex_editor2.png}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.8\textwidth]{lagrida_latex_editor3.png}\end{figure}
